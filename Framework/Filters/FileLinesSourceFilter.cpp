...
#include "FileLinesSourceFilter.h"
...
namespace AtomIT
{
  ...
  FileLinesSourceFilter::ReadMessage(Message& message,
                                     boost::filesystem::ifstream& stream)
  {
    ...
    {        
      ...
      message.SetValue(Orthanc::Toolbox::StripSpaces(s));
  ...
  FileLinesSourceFilter::FileLinesSourceFilter(const std::string& name,
