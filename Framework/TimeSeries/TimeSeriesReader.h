...
namespace AtomIT
{
  class TimeSeriesReader : public boost::noncopyable
  {
  private:
  ...
  public:
    ...
    public:
      explicit Transaction(TimeSeriesReader& reader);
      ...
      bool GetTimestamp(int64_t& result) const;
      ...
      bool SeekNearest(int64_t timestamp);
    ...
    TimeSeriesReader(ITimeSeriesManager& manager,
                     const std::string& name,
                     bool hasSynchronousWait);

    bool WaitModification(unsigned int milliseconds);
  };
}
